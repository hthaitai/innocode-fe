...
import { Clock, Cpu, FileCode, Download, CheckCircle2, XCircle } from "lucide-react";
...
const AutoResultExpandedRow = ({ details = [], artifacts = [] }) => {
  ...
  return (
    <div className="px-5">
      ...
      {details.length > 0 && (
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {details.map((d, index) => (
              <div key={d.detailsId} className="p-2 border border-gray-200 rounded-sm">
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-700">
                  <div className="flex items-center gap-1">
                    ...
                    Runtime: <span className="font-medium">{d.runtimeMs}ms</span>
                  </div>
      ...
      {artifacts.length > 0 && (
        <div>
          <h3 className="font-semibold text-sm leading-5 text-gray-800 mb-2">Submitted Files</h3>
          <div className="space-y-2">
            {artifacts.map((a) => (
              <div key={a.artifactId} className="flex items-center justify-between p-2 border border-gray-200 rounded-sm">
                ...
                <button
                  onClick={() => handleDownload(a.url, `submission-${a.artifactId}.py`)}
